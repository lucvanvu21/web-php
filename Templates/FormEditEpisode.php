...
<body>
    ...
    <div style="margin:40px 0px 70px 0px">
        <div class="container">
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="">Tổng số tập phim</label>
                ...
                <?php
                foreach ($episodesUrl as $result) { ?>
                    <div class="form-group">
                        <label for="">URL <?= $result['episode'] ?> <a class="text-danger" href="index.php?task=delepisode&movie_id=<?php echo $result['movie_id'] ?>&episode_id=<?php echo $result['episode_id']; ?>"> <i class="far fa-trash-alt"></i></a></label>
                        <input type="hidden" name="episode[]" value="<?= $result['episode'] ?>">
                        <input class="form-control" type="text" name="url<?= $result['episode'] ?>" value="<?= $result['url'] ?>">
                    </div>
                <?php } ?>
                ...
                <div class="form-group">
                    <input class="btn btn-primary" type="submit" name="update_episode" value="Cập nhật phim">
                </div>
            </form>
        </div>
    </div>
